...
st.title("📊 AAPL Stock Forecasting Dashboard")
st.subheader("📈 AAPL Closing Price")
st.line_chart(df.set_index("Date")["Close"])
st.subheader("📊 Closing Price with MA20")
...
ax2.legend()
st.pyplot(fig2)
st.header("🧠 Univariate LSTM (Close Price Only)")
...
st.header("🧠 Multivariate LSTM (Close + MA20 + RSI)")
...
import os
print(os.path.abspath("project.py"))
